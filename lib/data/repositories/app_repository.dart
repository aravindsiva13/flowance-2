...
//   Future<ProjectModel> createProject(Map<String, dynamic> data, {required DateTime startDate}) async {
//     try {
...
class AppRepository {
  ...
  Future<ProjectModel> createProject(
    ...
    try {
      return await _apiService.createProject(
        name: name,
        description: description,
        startDate: startDate,
        endDate: endDate,
  ...
  Future<ProjectModel> updateProject(
    ...
    try {
      return await _apiService.updateProject(
        projectId: projectId,
        name: name,
        description: description,
        status: status,
...
Future<void> deleteTimeEntry(String timeEntryId) async {
  try {
    await _apiService.deleteTimeEntry(timeEntryId);
  } catch (e) {
    throw Exception('Failed to delete time entry: ${e.toString()}');
  }
}
