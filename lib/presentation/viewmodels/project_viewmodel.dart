...
//     print('DEBUG: Loaded ${_projects.length} projects'); // ADD THIS
//     _projects.forEach((p) => print('Project: ${p.name}')); // ADD THIS
//   } catch (e) {
//     print('DEBUG: Error loading projects: $e'); // ADD THIS
    ...
    try {
      ...
      final duplicatedProject = await _repository.createProject(
        ...
        endDate: originalProject.endDate != null 
            ? DateTime.now().add(originalProject.endDate!.difference(originalProject.startDate))
            : null,
